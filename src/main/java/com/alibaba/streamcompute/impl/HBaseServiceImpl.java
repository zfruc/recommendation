...
public class HBaseServiceImpl implements StorageService, Serializable {
    ...
    @Override
    public List<Result> scanData(String tableName, ArrayList<Map<String, String>> filterInfos) throws IOException {
    ...
    @Override
    public void writeData(String tableName, String cfName, String rowKey, String data) throws IOException {
        Connection connection = HBaseUtil.getHbaseConnection();
        HTable table = (HTable) connection.getTable(TableName.valueOf(tableName));
