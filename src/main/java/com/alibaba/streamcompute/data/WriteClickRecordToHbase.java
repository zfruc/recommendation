...
public class WriteClickRecordToHbase {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < recordNum; i++) {
            ...
            put.addColumn(Bytes.toBytes("cf"), Bytes.toBytes("user_id"), Bytes.toBytes(String.valueOf(userId)));
            put.addColumn(Bytes.toBytes("cf"), Bytes.toBytes("item_id"), Bytes.toBytes(String.valueOf(itemId)));
            put.addColumn(Bytes.toBytes("cf"), Bytes.toBytes("flag"), Bytes.toBytes(String.valueOf(flag)));
