...
public class WriteToKafka {
    ...
    private static void send(String topic) {
        ...
        properties.put(Constants.KAFKA_KEY_SERIALIZER, "org.apache.kafka.common.serialization.StringSerializer");
        properties.put(Constants.KAFKA_VALUE_SERIALIZER, "org.apache.kafka.common.serialization.StringSerializer");
